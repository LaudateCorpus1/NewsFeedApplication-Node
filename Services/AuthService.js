...
const poolData = {
   UserPoolId: "us-east-2_2N438TayE",
   ClientId: "3qv7bmu51u92r7dkd5bbn800vu"
};
...
exports.ValidateOTP = function(body,callback) {
   var userName = body.email;
   var code = body.otp;
   var verficationDetails = new AmazonCognitoIdentity.ConfirmationCode({
   ...
   var userData = {
    ...
    cognitoUser.ConfirmationCode( verficationDetails, {
